...
export const VillageSelectProfile: React.FC<VillageSelectProps> = ({
  districtId,
  village,
  setVillage,
}) => {
  ...
  return (
    <Select
      isLoading={loading}
      options={options}
      value={options.find((item) => item.label === village) || null}
      onChange={(selected) => setVillage(selected?.label || "")}
      placeholder={village ? "" : "Pilih Desa/Kelurahan..."}
